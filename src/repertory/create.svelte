<script>
    ...
    import { CREATE_CONTACT } from "./query";
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            if(createContact._id) {
                messages = { ...messages, success: "Le contact a été ajouté avec succès", error: null };
            }
        } catch({ message }) {
...
<div class="md:flex md:items-center">
  <form class="w-full max-w-lg md:mx-auto py-4">
    ...
    <h3 class="text-center my-4">Create contact</h3>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input on:change={handleFirstNameChange} class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane">
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input on:change={handleLastNameChange} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Doe">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      ...
      <input on:change={handleEmailChange} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-email" type="email" placeholder="John.Doe@gmail.com">
  ...
  <div class="flex flex-wrap -mx-3 mb-2">
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input on:change={handleCountryCodeChange} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="number" value="0" placeholder="+33">
    ...
    <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
      ...
      <input on:change={handlePhoneNumberChange} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="6 1001 0034">
